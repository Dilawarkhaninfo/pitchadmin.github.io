...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addButton.addEventListener('click', function () {
    ...
    newRow.innerHTML = `
    <div class="d-flex justify-content-between border-0 ft_14 align-middle bg-light">
              <div class="d-flex align-items-center px-3">
                <div class="">
                  Condition 1: Between
                </div>
                <div class="">
                  <select class="form-select bg-transparent ft_14 border-0 text_red form-select-sm"
                ...
                <div class="">are priced at</div>
                <div class=""><select
                    class="form-select custom_form bg-transparent ft_14 border-0 text_red form-select-sm"
                    aria-label="To Time" id="select-box">
  ...
  `;
    // Add the prent_row class to the parent container
    ...
    // Initialize Select2 for the newly added multi-select dropdown

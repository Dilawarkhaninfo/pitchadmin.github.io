...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addButton.addEventListener('click', function () {
        ...
        newRow.innerHTML = `
        <div class="d-flex justify-content-between border-0 ft_16 align-middle bg-light">
        <div class="d-flex align-items-center px-3">
          <div class="">
            <button id="btn_selection5"
              class="form-control bg-transparent ft_16 text_red border-0 toggle-next ellipsis">
              All Spaces
